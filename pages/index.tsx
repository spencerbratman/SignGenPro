...
const SignatureGenerator: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>Create Your Free Digital Signature Online - No Registration Needed!</title>
        ...
        <meta property="og:url" content="https://yourdomain.com/signature-generator" />
        <meta property="og:image" content="https://yourdomain.com/signature-generator-preview.jpg" />
        <link rel="canonical" href="https://yourdomain.com/signature-generator" />
      </Head>
      ...
      <div className="max-w-4xl mx-auto p-4 pt-20 md:pt-32">
        <header className="text-center mb-4 md:mb-8">
          <h1 className="text-3xl md:text-5xl font-bold mb-2 md:mb-4">Create Your Free Digital Signature Online - No Registration Needed!</h1>
          <p className="text-lg md:text-xl text-gray-600 mb-4">Our free Signature Generator allows you to create a professional digital signature quickly and easily.</p>
